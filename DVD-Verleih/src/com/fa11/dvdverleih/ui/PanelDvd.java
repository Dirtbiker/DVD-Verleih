...
public class PanelDvd extends JPanel {
	...
	public PanelDvd() {
		...
		this.panelDvdControls.setBorder(new TitledBorder(null, "DVD erfassen",
		...
		gbl_panelDvdControls.columnWeights = new double[] { 0.0, 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
		gbl_panelDvdControls.rowWeights = new double[] { 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
		...
		gbl_panelDvdButtons.columnWeights = new double[] { 0.0, 0.0,
				Double.MIN_VALUE };
		...
		this.panelDvdPanel.setBorder(new TitledBorder(null, "Vorhandene DVDs",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		this.tableDvd = new DVDVerleihTable(new String[] { "DVD-Nr.", "Titel",
				"Genre", "Jahr" }, 0);
		...
		// .getModel();
		// txtDvdNo.setText(String.valueOf(model.getValueAt(tableDvd.getSelectedRow(),
		// 0)));
		// txtDvdTitle.setText(String.valueOf(model.getValueAt(tableDvd.getSelectedRow(),
		// 1)));
		// txtDvdGenre.setText(String.valueOf(model.getValueAt(tableDvd.getSelectedRow(),
		// 2)));
		// txtDvdYear.setText(String.valueOf(model.getValueAt(tableDvd.getSelectedRow(),
		// 3)));
		// }
		// }
		// });
		...
		gbl_panelDvdEditControls.columnWeights = new double[] { 0.0, 0.0,
				Double.MIN_VALUE };
		gbl_panelDvdEditControls.rowWeights = new double[] { 0.0,
				Double.MIN_VALUE };
